...
<body>
    ...
    <div class="header">
        ...
        <div class="navbar">
            <a href="/bookmanagement_crud_with_spring/book/showDeletedBooks">Delete History</a>
            <a href="/bookmanagement_crud_with_spring/">Log Out</a>
        </div>
    </div>
    ...
    <div class="container mt-5">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="/bookmanagement_crud_with_spring/book/insertBook" class="btn btn-sm btn-warning">
