        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form:form  modelAttribute="bean" action="/bookmanagement_crud_with_spring/book/addBook" method="post">
                            <div class="form-floating mb-3">
                                <form:input type="text" class="form-control" id="floatingTitle" placeholder="Enter Book Title...." path="title" />
                                <form:label for="floatingTitle" path="title">Title</form:label>
                            </div>
                            <div class="form-floating mb-3">
                                <form:input type="text" class="form-control" id="floatingAuthor" placeholder="Author" path="author" />
                                <form:label for="floatingAuthor" path="author">Author</form:label>
                            </div>
                            <div class="form-floating mb-3">
                                <form:input type="text" class="form-control" id="floatingPrice" placeholder="Price" path="price" />
                                <form:label for="floatingPrice" path="price">Price</form:label>
                            </div>
                             <div class="form-floating mb-3">
                                <form:input type="number" class="form-control" id="floatingPrice" placeholder="Quantity" path="quantity" />
